...
public class SlaveFederate extends SigarCommandBase implements PtolemyFederate {
	 ...
	 * deve ser diferente. E o último slave a ser executado deve receber o nome
	 * ReadyToRun
	 */
	...
	private static int slaveChannel = 2;
	...
	public void createFederate(String fedName, String fedFileName)
		...
		// publishAndSubscribe();
		publishAndSubscribe(slaveChannel);
	...
	/*
	 * 
	 * Reescrito para atender a comunicação por canais
	 */
	 ...
	 * all!
	 */
	private void sendInteraction(int data) throws RTIexception {
		// /////////////////////////////////////////////
		// create the necessary container and values //
		// /////////////////////////////////////////////
		...
		// C++
		byte[] xaValue = EncodingHelpers.encodeString("xa:" + data);
		byte[] xbValue = EncodingHelpers.encodeString("xb:" + (data + 1));
	...
	public static void main(String[] args) {
		...
		try {
			...
			new SlaveFederate().createFederate(federateName, "testfom.fed");
